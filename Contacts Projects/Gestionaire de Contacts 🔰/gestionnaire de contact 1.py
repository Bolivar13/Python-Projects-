...
def modifier():
    ...
    photo_3 = PhotoImage(file = "img/modify.png")
...
def afficher():
    ...
    photo_4 = PhotoImage(file = "img/afficher.png")
...
def chercher():
    ...
    photo_5 = PhotoImage(file = "img/chercher.png")
